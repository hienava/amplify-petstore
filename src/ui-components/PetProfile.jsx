...
export default function PetProfile(props) {
  ...
  const buttonThreeFourFiveTwoTwoSevenZeroThreeOnClick =
  ...
  return (
    ...
    >
      <Button
        ...
        children="Delete"
        onClick={() => {
          buttonThreeFourFiveTwoTwoSevenZeroThreeOnClick();
        }}
        {...getOverrideProps(overrides, "Button34522703")}
      ></Button>
      <Image
        width="129px"
        height="122px"
      ...
      <Button
        ...
        variation="primary"
        children="Update"
        {...getOverrideProps(overrides, "Button34522697")}
      ></Button>
    </Flex>
  );
}
